package com.dcinspirations.bookstore.ui.home;
...
//                        }
        ...
        buy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(getContext(), CheckOut.class).putExtra("data", checkoutAsString));
                checkoutlist.clear();
...
//        Collections.sort(filearray);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(getContext(), android.R.layout.simple_list_item_1, filearray.toArray(new String[filearray.size()]));
